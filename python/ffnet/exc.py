...
class RegularExpresssionFailed:
    def __init__(self, pattern, string):
        self.pattern = pattern
        self.string = string

    def __str__(self):
        return "Regular Expression '%s' Failed on '%s'" % self.pattern, self.string
...
class InvalidArgs(Exception):
    ...
    def __str__(self):
        return self.arg and "Invalid Arg: %s" % self.arg or "Invalid Arg"
